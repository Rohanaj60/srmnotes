        ...
        <div class="right-area">
            ...
            <div>
                <form class="form-section" enctype="multipart/form-data"  method="post">
                    ...
                    <input id="input-d" type="text" name="notes-title" required placeholder="Paper Title">
                    ...
                    <label id="lblid" for="file">Choose Paper</label>
...
$uploads_dir = './uploads';
    ...
    $sql =   "insert into papers values (NULL,'$title','$pname','$subject_id')";
