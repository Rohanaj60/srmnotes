...
<head>
    ...
    <title>Admin Dashboard | Modify Notes</title>
    <style>
    * {
        margin: 0;
        padding: 0;
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="mod-values">
                       ...
                       <a href="modifynote.php" class="btn1">Modify PDF</a>
                    </div>
            <div class="text-update">
                <form class="form-section" enctype="multipart/form-data"  method="post">
                    ...
                    <label id="lblid" for="select-subject">Select Notes</label>
                    <select id="input-d1" name="select-notes" class="select_notes">
                          
                    <option value="" disabled selected>--- Select Notes ---</option>
                    </select>
...
if (isset($_POST["submit"]))
 {
    ...
    //  $subject_id = $_POST["select-subject"];
        ...
        $notes_id = $_POST["select-notes"];
    
 
    #sql query to insert into database
    // $sql = "INSERT into notes VALUES(null,'$title','$pname','$subject_id)";
    $sql =   "update notes set note_name = '$title' where sn = '$notes_id' ";
...
if (isset($_POST["submitd"]))
 {
    ...
    #sql query to insert into database
    // $sql = "INSERT into notes VALUES(null,'$title','$pname','$subject_id)";
    $sql =   "delete from notes where sn = '$notes_id' ";
