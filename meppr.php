...
<head>
    ...
    <title>Mechanical Engineering Papers</title>
    ...
    <div class="outer-wrapper">
        <div class="material-wrapper">
            ...
            <div class="subject-list">
                ...
                <a href="me/paper/cad-cam.php" id="sub-style">
                    <div class="sub1">
                ...
                <a href="me/paper/h3.php" id="sub-style">
                    <div class="sub1">
                    <img src="images/mechanics-logo.png" alt="">
                        <p id="para">
                       H3
                ...
                <a href="me/paper/m3.php" id="sub-style">
                    <div class="sub1">
                    <img src="images/mechanics-logo.png" alt="">
                        <p id="para">
                       M3
                ...
                <a href="me/paper/mee.php" id="sub-style">
                    <div class="sub1">
                    <img src="images/mechanics-logo.png" alt="">
                        <p id="para">
                       ME
                ...
                <a href="me/paper/mmm.php" id="sub-style">
                    <div class="sub1">
                    <img src="images/mechanics-logo.png" alt="">
                        <p id="para">
                     MMM
                ...
                <a href="me/paper/mp.php" id="sub-style">
                    <div class="sub1">
                    <img src="images/mechanics-logo.png" alt="">
                        <p id="para">
                       MP
