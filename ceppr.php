...
<head>
    ...
    <title>Civil Engineering Paperrs</title>
...
<body>
    ...
    <div class="outer-wrapper">
        <div class="material-wrapper">
            <h1>Notes for Civil Engineering</h1>
            <div class="subject-list">


                <a href="CE/paper/dss.php" id="sub-style">
                    <div class="sub1">
                ...
                <a href="CE/paper/sa.php" id="sub-style">
                    <div class="sub1">
                        <img src="images/constructionlogo.png" alt="">
                        <p id="para">
                      SA
                ...
                <a href="CE/paper/ee.php" id="sub-style">
                    <div class="sub1">
                        <img src="images/constructionlogo.png" alt="">
                        <p id="para">
                       EE
                ...
                <a href="CE/paper/ge.php" id="sub-style">
                    <div class="sub1">
                        <img src="images/constructionlogo.png" alt="">
                        <p id="para">
                     GE
                ...
                <a href="CE/paper/te.php" id="sub-style">
                    <div class="sub1">
                        <img src="images/constructionlogo.png" alt="">
                        <p id="para">
                      TE
                ...
                <a href="CE/paper/eg.php" id="sub-style">
                    <div class="sub1">
                        <img src="images/constructionlogo.png" alt="">
                        <p id="para">
                     EG
                ...
                <a href="CE/paper/se.php" id="sub-style">
                    <div class="sub1">
                        <img src="images/constructionlogo.png" alt="">
                        <p id="para">
                     SE
                ...
                <a href="CE/paper/eee.php" id="sub-style">
                    <div class="sub1">
                        <img src="images/constructionlogo.png" alt="">
                        <p id="para">
                    EEE
                ...
                <a href="CE/paper/cem.php" id="sub-style">
                    <div class="sub1">
                        <img src="images/constructionlogo.png" alt="">
                        <p id="para">
