...
<head>
    ...
    <title>Civil Engineering Notes</title>
    ...
    <div class="outer-wrapper">
        <div class="material-wrapper">
            ...
            <div class="subject-list">
                ...
                <a href="CE/notes/dss.php" id="sub-style">
                    <div class="sub1">
                ...
                <a href="CE/notes/sa.php" id="sub-style">
                    <div class="sub1">
                        <img src="images/constructionlogo.png" alt="">
                        <p id="para">
                      SA
                ...
                <a href="CE/notes/ee.php" id="sub-style">
                    <div class="sub1">
                        <img src="images/constructionlogo.png" alt="">
                        <p id="para">
                       EE
                ...
                <a href="CE/notes/ge.php" id="sub-style">
                    <div class="sub1">
                        <img src="images/constructionlogo.png" alt="">
                        <p id="para">
                     GE
                ...
                <a href="CE/notes/te.php" id="sub-style">
                    <div class="sub1">
                        <img src="images/constructionlogo.png" alt="">
                        <p id="para">
                      TE
                ...
                <a href="CE/notes/eg.php" id="sub-style">
                    <div class="sub1">
                        <img src="images/constructionlogo.png" alt="">
                        <p id="para">
                     EG
                ...
                <a href="CE/notes/se.php" id="sub-style">
                    <div class="sub1">
                        <img src="images/constructionlogo.png" alt="">
                        <p id="para">
                     SE
                ...
                <a href="CE/notes/eee.php" id="sub-style">
                    <div class="sub1">
                        <img src="images/constructionlogo.png" alt="">
                        <p id="para">
                    EEE
                ...
                <a href="CE/notes/cem.php" id="sub-style">
                    <div class="sub1">
                        <img src="images/constructionlogo.png" alt="">
                        <p id="para">
